...
/// A convenience wrapper around `TextField` and `PaddingAvoider` that makes it
...
/// [keyboardOffset] is the vertical distance that the `SmartPadTextField` will
...
///
class SmartPadTextField extends StatelessWidget {
  SmartPadTextField({
    Key? key,
